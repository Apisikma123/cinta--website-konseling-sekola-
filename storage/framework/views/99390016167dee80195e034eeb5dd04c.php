...
<div class="w-full px-4 sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Pantau laporan siswa di <strong class="text-gray-800"><?php echo e($teacher->school ?? 'sekolah Anda'); ?></strong>
            </p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-2"><?php echo e($totalReports); ?></p>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-2"><?php echo e($studentCount); ?></p>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
            <div class="flex items-start justify-between gap-3">
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-base font-bold text-gray-900 mt-2 truncate"><?php echo e($teacher->school ?? '—'); ?></p>
    ...
    <div class="grid grid-cols-3 gap-3">
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 text-center">
            <p class="text-2xl font-bold text-amber-700"><?php echo e($statusChart['baru'] ?? 0); ?></p>
            <p class="text-xs font-medium text-amber-600 mt-0.5">Baru</p>
        </div>
        <div class="bg-purple-50 border border-purple-200 rounded-lg p-3 text-center">
            <p class="text-2xl font-bold text-purple-700"><?php echo e($statusChart['diproses'] ?? 0); ?></p>
        ...
        <div class="bg-emerald-50 border border-emerald-200 rounded-lg p-3 text-center">
            <p class="text-2xl font-bold text-emerald-700"><?php echo e($statusChart['selesai'] ?? 0); ?></p>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 flex items-center gap-3">
        ...
        <p class="text-sm text-blue-800">
            Notifikasi laporan hanya untuk sekolah <strong><?php echo e($teacher->school ?? '—'); ?></strong>
        </p>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-5 py-3.5 border-b border-gray-100 flex items-center justify-between flex-wrap gap-3">
            ...
            <a href="<?php echo e(route('teacher.reports.index')); ?>" class="text-sm font-medium text-purple-600 hover:text-purple-700">
            ...
            <table class="w-full min-w-[640px]">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-5 py-3">
                            <p class="text-sm font-semibold text-gray-900 truncate max-w-[200px]"><?php echo e($report->title); ?></p>
                            <code class="text-xs text-gray-400 bg-gray-50 px-1.5 py-0.5 rounded border border-gray-100 font-mono">#<?php echo e($report->tracking_code); ?></code>
                        </td>
                        <td class="px-4 py-3">
                            <p class="text-sm font-medium text-gray-800"><?php echo e($report->nama_murid); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($report->nama_sekolah); ?> · <?php echo e($report->kelas); ?></p>
                        </td>
                        <td class="px-4 py-3 text-sm text-gray-600"><?php echo e(ucfirst($report->jenis_laporan ?? '—')); ?></td>
                        <td class="px-4 py-3 text-sm text-gray-500 whitespace-nowrap"><?php echo e($report->created_at->translatedFormat('d M Y')); ?></td>
                        <td class="px-4 py-3">
                            ...
                            <?php else: ?>
                                <span class="inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 border border-gray-200">
                                    <span class="w-1.5 h-1.5 rounded-full bg-gray-400"></span><?php echo e(ucfirst($report->status)); ?>

                                </span>
                            <?php endif; ?>
                        </td>
                        <td class="px-5 py-3 text-right">
                            <a href="<?php echo e(route('teacher.reports.show', $report)); ?>"
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm py-14 text-center">
        ...
        <p class="text-sm text-gray-500 mt-1">Laporan dari siswa <?php echo e($teacher->school ?? ''); ?> akan tampil di sini</p>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.teacher', ['title' => 'Dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ngoding\sistem-cinta\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>