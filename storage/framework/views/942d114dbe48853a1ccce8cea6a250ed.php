...
<head>
    ...
    <title><?php echo e($title ?? 'Sistem Laporan BK'); ?></title>
    ...
    <?php if(config('recaptcha.enabled', false)): ?>
    <!-- Google reCAPTCHA v3 -->
...
<body class="bg-purple-50 min-h-screen p-4 sm:p-6">
    <div class="w-full max-w-6xl mx-auto">
        <div class="text-center mb-6 sm:mb-8 fade-in">
            ...
            <h1 class="text-xl sm:text-2xl font-bold text-purple-800"><?php echo e($title ?? 'Sistem Laporan BK'); ?></h1>
        </div>
        ...
        <footer class="text-center mt-4 sm:mt-6 text-xs text-purple-600">
            © <?php echo e(date('Y')); ?> Sistem Laporan BK
        </footer>
    </div>
