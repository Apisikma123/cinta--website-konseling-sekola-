...
<form method="POST" action="<?php echo e(route('login.store')); ?>" id="loginForm">
    ...
    <div class="space-y-5">
        ...
        <button type="submit" id="login-btn" class="w-full justify-center inline-flex items-center bg-purple-600 hover:bg-purple-700 active:scale-95 text-white font-bold py-3 px-4 rounded-lg transition duration-200 mt-8">
