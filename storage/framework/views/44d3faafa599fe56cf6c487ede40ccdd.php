...
<div class="text-center mb-8">
    <h1 class="text-3xl font-bold text-gray-900 mb-3"><?php echo e($title); ?></h1>
    <p class="text-gray-600 text-base"><?php echo e($subtitle); ?></p>
</div>
...
<!-- Form -->
<form method="POST" action="<?php echo e($formAction); ?>" id="otpForm" class="max-w-2xl mx-auto">
    <?php echo csrf_field(); ?>
    ...
    <?php if(isset($backRoute)): ?>
        <div class="mt-6 text-center">
            <a href="<?php echo e($backRoute); ?>" class="text-sm text-gray-600 hover:text-gray-900">
...
(function() {
    ...
    resendBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const res = await fetch('<?php echo e(route($resendRoute)); ?>', {
                method: 'POST',
                headers: {
