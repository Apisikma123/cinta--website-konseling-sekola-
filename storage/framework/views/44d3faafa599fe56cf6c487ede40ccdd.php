...
<div class="text-center mb-6">
    ...
    <!-- Title & Subtitle -->
    <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-1"><?php echo e($title); ?></h1>
    <p class="text-gray-600 text-sm md:text-base mb-3"><?php echo e($subtitle); ?></p>
</div>
...
<div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
    <div class="flex items-center justify-center gap-3">
        ...
        <div class="text-left">
            ...
            <p class="text-sm md:text-base font-semibold text-gray-800 break-all" id="emailDisplay"><?php echo e($email ?? session('pending_email')); ?></p>
        </div>
    </div>
</div>
...
<!-- Form -->
<form method="POST" action="<?php echo e($formAction); ?>" id="otpForm" autocomplete="off">
    <?php echo csrf_field(); ?>
    ...
    <?php if(isset($backRoute)): ?>
        <div class="mt-4 text-center">
            <a href="<?php echo e($backRoute); ?>" class="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-purple-600 transition">
...
(function() {
    ...
    function startExpiredTimer(isFreshStart = false) {
        ...
        if (!isFreshStart) {
            const sentAt = <?php echo e(session('otp_sent_at', 0)); ?> * 1000;
            if (sentAt) {
    ...
    resendBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route($resendRoute)); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.auth', ['title' => $title], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ngoding\sistem-cinta\resources\views/auth/otp.blade.php ENDPATH**/ ?>