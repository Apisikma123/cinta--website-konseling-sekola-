...
<head>
    ...
    <title><?php echo e(config('app.name', 'Sistem BK Digital')); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 md:h-20 items-center">
                ...
                <div class="flex items-center gap-2 md:gap-3">
                    <img src="<?php echo e(asset('img/icon.png')); ?>" alt="Logo Sistem BK" class="w-9 h-9 md:w-11 md:h-11 object-contain">
