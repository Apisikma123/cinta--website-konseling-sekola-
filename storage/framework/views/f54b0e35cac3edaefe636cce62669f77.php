...
<div x-data="{ open: false }" class="relative">
    <button @click="open = !open" 
        ...
        <?php else: ?>
            <div class="w-9 h-9 rounded-full bg-purple-600 text-white flex items-center justify-center text-xs font-bold flex-shrink-0">
                <?php echo e($navInitials ?: strtoupper(substr(auth()->user()->name, 0, 1))); ?>
    ...
    <div x-show="open" 
        ...
        <a href="<?php echo e($profileRoute); ?>" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50">
            ...
            <?php echo e($role === 'teacher' ? 'Profil Saya' : 'Profil'); ?>

        </a>
        <a href="<?php echo e($settingsRoute); ?>" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50">
...
<?php /**PATH D:\ngoding\sistem-cinta\resources\views/layouts/partials/profile-dropdown.blade.php ENDPATH**/ ?>