        ...
        <form id="reportForm">
                ...
                <div class="relative">
                    <select name="school_id" required
                        ...
                        <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($school->id); ?>"><?php echo e($school->name); ?><?php if($school->city): ?> - <?php echo e($school->city); ?><?php endif; ?></option>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <?php $__currentLoopData = $jenisOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="jenis-card group border border-purple-100 rounded-xl p-4 cursor-pointer bg-white hover:border-purple-300 hover:shadow-sm transition relative">
                            <input type="checkbox" name="jenis_laporan" value="<?php echo e($option['value']); ?>" class="jenis-input hidden"
                                   <?php echo e(old('jenis_laporan') === $option['value'] ? 'checked' : ''); ?>>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900"><?php echo e($option['label']); ?></p>
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($option['desc']); ?></p>
                                </div>
                            </div>
                        </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['message' => 'Memproses laporan Anda...']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['type' => 'button','variant' => 'outline','class' => 'w-full justify-center','onclick' => 'copyCode()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'outline','class' => 'w-full justify-center','onclick' => 'copyCode()']); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['type' => 'button','variant' => 'primary','class' => 'w-full justify-center','onclick' => 'goHome()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'primary','class' => 'w-full justify-center','onclick' => 'goHome()']); ?>
