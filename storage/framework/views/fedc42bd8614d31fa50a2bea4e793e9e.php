...
<head>
    ...
    <title><?php echo e($title ?? 'Guru BK'); ?> · BK Panel</title>
...
<div class="layout-wrapper">
    ...
    <aside class="sidebar" :class="sidebarOpen ? 'mobile-open' : ''">
        <?php echo $__env->make('layouts.partials.teacher-sidebar-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </aside>
    ...
    <div class="main-content">
        ...
        <header class="sticky top-0 z-30 bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4">
            ...
            <?php echo $__env->make('layouts.partials.profile-dropdown', ['role' => 'teacher'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </header>
...
<?php /**PATH D:\ngoding\sistem-cinta\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>