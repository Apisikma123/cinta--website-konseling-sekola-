...
<nav class="flex-1 px-3 py-3 overflow-y-auto space-y-1">
    ...
    <a href="/admin/dashboard" @click="sidebarOpen = false"
       class="flex items-center gap-3 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors duration-150 {{ request()->is('admin/dashboard') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
        <i class="fas fa-table-cells-large w-5 text-center {{ request()->is('admin/dashboard') ? 'text-purple-600' : 'text-gray-400' }}"></i>
        <span>Dashboard</span>
    </a>

    <a href="/admin/approve-teachers" @click="sidebarOpen = false"
       class="flex items-center gap-3 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors duration-150 {{ request()->is('admin/approve-teachers') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
    ...
    <a href="/admin/teachers" @click="sidebarOpen = false"
       class="flex items-center gap-3 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors duration-150 {{ request()->is('admin/teachers') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
    ...
    <a href="/admin/schools" @click="sidebarOpen = false"
       class="flex items-center gap-3 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors duration-150 {{ request()->is('admin/schools') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
        <i class="fas fa-school w-5 text-center {{ request()->is('admin/schools') ? 'text-purple-600' : 'text-gray-400' }}"></i>
        <span>Data Sekolah</span>
    </a>

    <a href="{{ route('admin.testimonials') }}" @click="sidebarOpen = false"
       class="flex items-center gap-3 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors duration-150 {{ request()->routeIs('admin.testimonials') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
        <i class="fas fa-star w-5 text-center {{ request()->routeIs('admin.testimonials') ? 'text-purple-600' : 'text-amber-400' }}"></i>
        <span>Testimoni</span>
    </a>
    ...
    <a href="{{ route('admin.profile') }}" @click="sidebarOpen = false"
       class="flex items-center gap-3 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors duration-150 {{ request()->routeIs('admin.profile') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
    ...
    <a href="{{ route('admin.settings') }}" @click="sidebarOpen = false"
       class="flex items-center gap-3 py-2.5 px-4 rounded-lg text-sm font-medium transition-colors duration-150 {{ request()->routeIs('admin.settings') ? 'bg-purple-100 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
