    ...
    <nav id="navbar" class="sticky top-0 z-50 bg-white/90 backdrop-blur-lg border-b border-gray-100 fade-down">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 md:h-20 items-center">
                ...
                <div class="hidden md:flex items-center gap-1 xl:gap-2">
                    ...
                    <a href="{{ route('student.create') }}" class="menu-link flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 hover:text-purple-600 transition-colors duration-300">
                        <i data-feather="edit" class="w-4 h-4"></i>
                        <span>Buat Laporan</span>
                    </a>
                    <a href="{{ route('student.track') }}" class="menu-link flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 hover:text-purple-600 transition-colors duration-300">
                        <i data-feather="search" class="w-4 h-4"></i>
                        <span>Lacak Status</span>
                    </a>
                    <a href="{{ route('login') }}" class="btn-login flex items-center gap-2 ml-2 px-6 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold rounded-xl shadow-md">
        ...
        <div id="mobileMenu" class="mobile-menu md:hidden bg-white border-t border-gray-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 py-5 space-y-1">
                ...
                <a href="{{ route('student.create') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 text-sm font-semibold text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-300">
                    <i data-feather="edit" class="w-5 h-5"></i>
                    <span>Buat Laporan</span>
                </a>
                <a href="{{ route('student.track') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 text-sm font-semibold text-gray-700 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-all duration-300">
                    <i data-feather="search" class="w-5 h-5"></i>
                    <span>Lacak Status</span>
                </a>
                <div class="mobile-menu-item pt-2 border-t border-gray-100">
                    <a href="{{ route('login') }}" class="flex items-center justify-center gap-2 w-full py-3.5 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-xl shadow-md transition-all duration-300">
