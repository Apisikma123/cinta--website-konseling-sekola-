    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl text-white py-12 sm:py-16 px-6 scroll-animate">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                <div>
                    <div class="text-4xl sm:text-5xl font-bold mb-2">{{ $stats['total'] }}+</div>
                    <p class="text-purple-100">Laporan Tertangani</p>
                </div>
                <div>
                    <div class="text-4xl sm:text-5xl font-bold mb-2">{{ $stats['completed_percent'] }}%</div>
                    <p class="text-purple-100">Laporan Selesai</p>
                </div>
                <div>
                    <div class="text-4xl sm:text-5xl font-bold mb-2">{{ $stats['schools'] }}</div>
...
<section class="py-12 sm:py-16 mb-8 sm:mb-12 bg-gradient-to-b from-purple-50/50 to-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-10">
            @foreach($teachers as $schoolName => $schoolTeachers)
                <div class="scroll-animate">
                    <!-- School Name Header -->
...
<section class="py-12 sm:py-16 mb-8 sm:mb-12">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Loop by school --}}
        @foreach($testimonials as $schoolName => $schoolTestimonials)
        <div class="mb-12">
                ...
                <div class="scroll-animate">
                    <div class="testimonial-card bg-white rounded-2xl p-6 border border-purple-100 h-full flex flex-col shadow-sm">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="testimonial-name text-sm font-semibold text-gray-900">{{ $testimonial->is_anonymous ? 'Murid Anonim' : $testimonial->student_name }}</p>
                                <p class="text-xs text-gray-500">{{ $testimonial->report->nama_sekolah ?? 'Siswa Puas' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-sm sm:text-base font-bold text-purple-600 ml-4 flex-shrink-0">{{ $item['percent'] }}%</span>
                    </div>
                    <div class="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-purple-500 to-purple-600 rounded-full transition-all duration-500" 
                             style="width: {{ $item['percent'] }}%; animation: slideIn 0.8s ease forwards; animation-delay: 0.2s;">
                        </div>
                    </div>
                </div>
                @endforeach
