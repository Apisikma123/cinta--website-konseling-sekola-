    ...
    <div class="max-w-2xl w-full">
        ...
        <div class="text-center mb-8">
            <svg class="float-animation w-32 h-32 sm:w-48 sm:h-48 mx-auto mb-6" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(150, 200)">
                    <circle cx="0" cy="0" r="25" fill="#DDD6FE" stroke="#C4B5FD" stroke-width="2"/>
                    <!-- Lock symbol -->
                    <rect x="-8" y="-5" width="16" height="14" rx="2" fill="none" stroke="#7E22CE" stroke-width="2"/>
                    <path d="M -8 -5 Q -8 -10 -3 -10 Q 0 -10 3 -10 Q 8 -10 8 -5" stroke="#7E22CE" stroke-width="2" fill="none"/>
                    <circle cx="0" cy="2" r="2" fill="#7E22CE"/>
                </g>
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-6 sm:p-10 border border-purple-100 text-center">
            ...
            <p class="text-sm sm:text-base text-gray-500 mb-8">
                Jika Anda merasa ini adalah kesalahan, hubungi administrator atau pemilik akun Anda.
            </p>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl p-4 sm:p-6 mb-8 border border-purple-100">
                <div class="flex items-center justify-center gap-2 mb-2">
                    ...
                    <p class="text-sm text-purple-700 font-semibold">Akses Terbatas</p>
                </div>
                <p class="text-xs sm:text-sm text-gray-700">
                    Error Code: <span class="font-mono font-bold text-purple-600">{{ $exception->getStatusCode() }}</span> — 
                    <span class="text-gray-600">Forbidden Access</span>
                </p>
            </div>
            ...
            <div class="bg-blue-50 rounded-xl p-4 sm:p-6 mb-8 border border-blue-200 text-left">
                ...
                <ul class="text-xs sm:text-sm text-gray-700 space-y-2">
                    <li class="flex gap-2">
                        ...
                        <span>Anda tidak memiliki role/permission yang tepat</span>
                    </li>
                    <li class="flex gap-2">
                        <span class="text-blue-600 font-bold min-w-fit">•</span>
                        <span>Konten/file yang Anda cari bersifat private</span>
                    </li>
                    <li class="flex gap-2">
                        <span class="text-blue-600 font-bold min-w-fit">•</span>
                        <span>Akun Anda tidak aktif atau belum diverifikasi</span>
                    </li>
                </ul>
            </div>
