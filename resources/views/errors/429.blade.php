    ...
    <div class="max-w-2xl w-full">
        ...
        <div class="text-center mb-8">
            <svg class="float-animation w-32 h-32 sm:w-48 sm:h-48 mx-auto mb-6" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(150, 200)">
                    ...
                    <!-- Speed gauge -->
                    <path d="M -15 5 Q 0 15 15 5" stroke="#7E22CE" stroke-width="2" fill="none"/>
                    <line x1="-8" y1="3" x2="-10" y2="8" stroke="#7E22CE" stroke-width="1.5"/>
                    <line x1="0" y1="0" x2="5" y2="12" stroke="#7E22CE" stroke-width="2"/>
                    <line x1="8" y1="3" x2="10" y2="8" stroke="#7E22CE" stroke-width="1.5"/>
                    <circle cx="0" cy="5" r="2" fill="#7E22CE"/>
                </g>
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-6 sm:p-10 border border-purple-100 text-center">
            ...
            <p class="text-sm sm:text-base text-gray-500 mb-8">
                Silakan tunggu beberapa saat sebelum mencoba lagi. Sistem kami membatasi permintaan untuk menjaga keamanan dan performa.
            </p>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl p-4 sm:p-6 mb-8 border border-purple-100">
                <div class="flex items-center justify-center gap-2 mb-2">
                    ...
                    <p class="text-sm text-purple-700 font-semibold">Terlalu Banyak Permintaan</p>
                </div>
                <p class="text-xs sm:text-sm text-gray-700">
                    Error Code: <span class="font-mono font-bold text-purple-600">{{ $exception->getStatusCode() }}</span> —
                    <span class="text-gray-600">Too Many Requests</span>
                </p>
            </div>

            <!-- Countdown Timer -->
            <div class="bg-purple-50 rounded-xl p-4 sm:p-6 mb-8 border border-purple-200">
                <p class="text-sm font-semibold text-purple-900 mb-3 flex items-center justify-center gap-2">
                    <i class="fas fa-hourglass-start text-purple-600"></i>
                    Silakan tunggu sebelum mencoba lagi
                </p>
                <p class="text-xs sm:text-sm text-gray-700">
                    Batas permintaan akan direset setelah beberapa menit. Jangan mencoba refresh atau mengirim ulang terlalu sering.
                </p>
            </div>
        ...
        <div class="text-center mt-8">
            <p class="text-xs sm:text-sm text-gray-500">
                Jika Anda merasa ini adalah kesalahan, hubungi kami di <a href="mailto:cintakonseling@cinta-inovasi.my.id" class="underline hover:text-gray-700">cintakonseling@cinta-inovasi.my.id</a>
            </p>
        </div>
    </div>
</body>
